...
function Home() {
    ...
    return (
        <div className="max-w-screen min-h-screen bg-[#F3F4F6] p-[1rem]" >
            {studentToDelete && 
            ...
            <div className="block justify-items-center mb-7">
                ...
                <Link to='/create'>
                    <button className="bg-green-500 rounded-[5px] font-semibold text-white p-2 cursor-pointer lg:text-2xl lg:p-3">Add Student +</button>
                </Link>
            </div>
